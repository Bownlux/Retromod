...
public class ResourcePackTransformer {
    ...
    static {
        // item textures
        TEXTURE_RENAMES_BLOCKS.put("apple_golden", "golden_apple");
        TEXTURE_RENAMES_BLOCKS.put("beef_cooked", "cooked_beef");
        TEXTURE_RENAMES_BLOCKS.put("beef_raw", "beef");
        TEXTURE_RENAMES_BLOCKS.put("book_enchanted", "enchanted_book");
        TEXTURE_RENAMES_BLOCKS.put("book_normal", "book");
        TEXTURE_RENAMES_BLOCKS.put("book_writable", "writable_book");
        TEXTURE_RENAMES_BLOCKS.put("book_written", "written_book");
        TEXTURE_RENAMES_BLOCKS.put("bow_standby", "bow");
        TEXTURE_RENAMES_BLOCKS.put("bucket_empty", "bucket");
        TEXTURE_RENAMES_BLOCKS.put("bucket_lava", "lava_bucket");
        TEXTURE_RENAMES_BLOCKS.put("bucket_milk", "milk_bucket");
        TEXTURE_RENAMES_BLOCKS.put("bucket_water", "water_bucket");
        TEXTURE_RENAMES_BLOCKS.put("carrot_golden", "golden_carrot");
        TEXTURE_RENAMES_BLOCKS.put("chicken_cooked", "cooked_chicken");
        TEXTURE_RENAMES_BLOCKS.put("chicken_raw", "chicken");
        TEXTURE_RENAMES_BLOCKS.put("chorus_fruit_popped", "popped_chorus_fruit");
        TEXTURE_RENAMES_BLOCKS.put("door_acacia", "acacia_door");
        TEXTURE_RENAMES_BLOCKS.put("door_birch", "birch_door");
        TEXTURE_RENAMES_BLOCKS.put("door_dark_oak", "dark_oak_door");
        TEXTURE_RENAMES_BLOCKS.put("door_iron", "iron_door");
        TEXTURE_RENAMES_BLOCKS.put("door_jungle", "jungle_door");
        TEXTURE_RENAMES_BLOCKS.put("door_spruce", "spruce_door");
        TEXTURE_RENAMES_BLOCKS.put("door_wood", "oak_door");
        TEXTURE_RENAMES_BLOCKS.put("dye_powder_black", "ink_sac");
        TEXTURE_RENAMES_BLOCKS.put("dye_powder_blue", "lapis_lazuli");
        TEXTURE_RENAMES_BLOCKS.put("dye_powder_brown", "cocoa_beans");
        TEXTURE_RENAMES_BLOCKS.put("dye_powder_cyan", "cyan_dye");
        TEXTURE_RENAMES_BLOCKS.put("dye_powder_gray", "gray_dye");
        TEXTURE_RENAMES_BLOCKS.put("dye_powder_green", "cactus_green");
        TEXTURE_RENAMES_BLOCKS.put("dye_powder_light_blue", "light_blue_dye");
        TEXTURE_RENAMES_BLOCKS.put("dye_powder_lime", "lime_dye");
        TEXTURE_RENAMES_BLOCKS.put("dye_powder_magenta", "magenta_dye");
        TEXTURE_RENAMES_BLOCKS.put("dye_powder_orange", "orange_dye");
        TEXTURE_RENAMES_BLOCKS.put("dye_powder_pink", "rose_red");
        TEXTURE_RENAMES_BLOCKS.put("dye_powder_purple", "purple_dye");
        TEXTURE_RENAMES_BLOCKS.put("dye_powder_red", "rose_red");
        TEXTURE_RENAMES_BLOCKS.put("dye_powder_silver", "light_gray_dye");
        TEXTURE_RENAMES_BLOCKS.put("dye_powder_white", "bone_meal");
        TEXTURE_RENAMES_BLOCKS.put("dye_powder_yellow", "dandelion_yellow");
        TEXTURE_RENAMES_BLOCKS.put("fireball", "fire_charge");
        TEXTURE_RENAMES_BLOCKS.put("fireworks", "firework_rocket");
        TEXTURE_RENAMES_BLOCKS.put("fireworks_charge", "firework_star");
        TEXTURE_RENAMES_BLOCKS.put("fireworks_charge_overlay", "firework_star_overlay");
        TEXTURE_RENAMES_BLOCKS.put("fish_clownfish_raw", "tropical_fish");
        TEXTURE_RENAMES_BLOCKS.put("fish_cod_cooked", "cooked_cod");
        TEXTURE_RENAMES_BLOCKS.put("fish_cod_raw", "cod");
        TEXTURE_RENAMES_BLOCKS.put("fish_pufferfish_raw", "pufferfish");
        TEXTURE_RENAMES_BLOCKS.put("fish_salmon_cooked", "cooked_salmon");
        TEXTURE_RENAMES_BLOCKS.put("fish_salmon_raw", "salmon");
        TEXTURE_RENAMES_BLOCKS.put("fishing_rod_uncast", "fishing_rod");
        TEXTURE_RENAMES_BLOCKS.put("gold_axe", "golden_axe");
        TEXTURE_RENAMES_BLOCKS.put("gold_boots", "golden_boots");
        TEXTURE_RENAMES_BLOCKS.put("gold_chestplate", "golden_chestplate");
        TEXTURE_RENAMES_BLOCKS.put("gold_helmet", "golden_helmet");
        TEXTURE_RENAMES_BLOCKS.put("gold_hoe", "golden_hoe");
        TEXTURE_RENAMES_BLOCKS.put("gold_horse_armor", "golden_horse_armor");
        TEXTURE_RENAMES_BLOCKS.put("gold_leggings", "golden_leggings");
        TEXTURE_RENAMES_BLOCKS.put("gold_pickaxe", "golden_pickaxe");
        TEXTURE_RENAMES_BLOCKS.put("gold_shovel", "golden_shovel");
        TEXTURE_RENAMES_BLOCKS.put("gold_sword", "golden_sword");
        TEXTURE_RENAMES_BLOCKS.put("map_empty", "map");
        TEXTURE_RENAMES_BLOCKS.put("map_filled", "filled_map");
        TEXTURE_RENAMES_BLOCKS.put("map_filled_markings", "filled_map_markings");
        TEXTURE_RENAMES_BLOCKS.put("melon", "melon_slice");
        TEXTURE_RENAMES_BLOCKS.put("melon_speckled", "glistering_melon_slice");
        TEXTURE_RENAMES_BLOCKS.put("minecart_chest", "chest_minecart");
        TEXTURE_RENAMES_BLOCKS.put("minecart_command_block", "command_block_minecart");
        TEXTURE_RENAMES_BLOCKS.put("minecart_furnace", "furnace_minecart");
        TEXTURE_RENAMES_BLOCKS.put("minecart_hopper", "hopper_minecart");
        TEXTURE_RENAMES_BLOCKS.put("minecart_normal", "minecart");
        TEXTURE_RENAMES_BLOCKS.put("minecart_tnt", "tnt_minecart");
        TEXTURE_RENAMES_BLOCKS.put("mutton_cooked", "cooked_mutton");
        TEXTURE_RENAMES_BLOCKS.put("mutton_raw", "mutton");
        TEXTURE_RENAMES_BLOCKS.put("netherbrick", "nether_brick");
        TEXTURE_RENAMES_BLOCKS.put("porkchop_cooked", "cooked_porkchop");
        TEXTURE_RENAMES_BLOCKS.put("porkchop_raw", "porkchop");
        TEXTURE_RENAMES_BLOCKS.put("potato_baked", "baked_potato");
        TEXTURE_RENAMES_BLOCKS.put("potato_poisonous", "poisonous_potato");
        TEXTURE_RENAMES_BLOCKS.put("potion_bottle_drinkable", "potion");
        TEXTURE_RENAMES_BLOCKS.put("potion_bottle_empty", "glass_bottle");
        TEXTURE_RENAMES_BLOCKS.put("potion_bottle_lingering", "lingering_potion");
        TEXTURE_RENAMES_BLOCKS.put("potion_bottle_splash_potion", "splash_potion");
        TEXTURE_RENAMES_BLOCKS.put("rabbit_cooked", "cooked_rabbit");
        TEXTURE_RENAMES_BLOCKS.put("rabbit_raw", "rabbit");
        TEXTURE_RENAMES_BLOCKS.put("record_11", "music_disc_11");
        TEXTURE_RENAMES_BLOCKS.put("record_13", "music_disc_13");
        TEXTURE_RENAMES_BLOCKS.put("record_blocks", "music_disc_blocks");
        TEXTURE_RENAMES_BLOCKS.put("record_cat", "music_disc_cat");
        TEXTURE_RENAMES_BLOCKS.put("record_chirp", "music_disc_chirp");
        TEXTURE_RENAMES_BLOCKS.put("record_far", "music_disc_far");
        TEXTURE_RENAMES_BLOCKS.put("record_mall", "music_disc_mall");
        TEXTURE_RENAMES_BLOCKS.put("record_mellohi", "music_disc_mellohi");
        TEXTURE_RENAMES_BLOCKS.put("record_stal", "music_disc_stal");
        TEXTURE_RENAMES_BLOCKS.put("record_strad", "music_disc_strad");
        TEXTURE_RENAMES_BLOCKS.put("record_wait", "music_disc_wait");
        TEXTURE_RENAMES_BLOCKS.put("record_ward", "music_disc_ward");
        TEXTURE_RENAMES_BLOCKS.put("redstone_dust", "redstone");
        TEXTURE_RENAMES_BLOCKS.put("seeds_melon", "melon_seeds");
        TEXTURE_RENAMES_BLOCKS.put("seeds_pumpkin", "pumpkin_seeds");
        TEXTURE_RENAMES_BLOCKS.put("seeds_wheat", "wheat_seeds");
        TEXTURE_RENAMES_BLOCKS.put("slimeball", "slime_ball");
        TEXTURE_RENAMES_BLOCKS.put("totem", "totem_of_undying");
        TEXTURE_RENAMES_BLOCKS.put("wood_axe", "wooden_axe");
        TEXTURE_RENAMES_BLOCKS.put("wood_hoe", "wooden_hoe");
        TEXTURE_RENAMES_BLOCKS.put("wood_pickaxe", "wooden_pickaxe");
        TEXTURE_RENAMES_BLOCKS.put("wood_shovel", "wooden_shovel");
        TEXTURE_RENAMES_BLOCKS.put("wood_sword", "wooden_sword");
        TEXTURE_RENAMES_BLOCKS.put("wooden_armorstand", "armor_stand");
    }
