...
public class ResourcePackTransformer {
    ...
    static {
        ...
        TEXTURE_RENAMES.put("reeds", "sugar_cane"); // both item and block form
        ...
        // item textures
        TEXTURE_RENAMES.put("apple_golden", "golden_apple");
        TEXTURE_RENAMES.put("beef_cooked", "cooked_beef");
        TEXTURE_RENAMES.put("beef_raw", "beef");
        TEXTURE_RENAMES.put("book_enchanted", "enchanted_book");
        TEXTURE_RENAMES.put("book_normal", "book");
        TEXTURE_RENAMES.put("book_writable", "writable_book");
        TEXTURE_RENAMES.put("book_written", "written_book");
        TEXTURE_RENAMES.put("bow_standby", "bow");
        TEXTURE_RENAMES.put("bucket_empty", "bucket");
        TEXTURE_RENAMES.put("bucket_lava", "lava_bucket");
        TEXTURE_RENAMES.put("bucket_milk", "milk_bucket");
        TEXTURE_RENAMES.put("bucket_water", "water_bucket");
        TEXTURE_RENAMES.put("carrot_golden", "golden_carrot");
        TEXTURE_RENAMES.put("chicken_cooked", "cooked_chicken");
        TEXTURE_RENAMES.put("chicken_raw", "chicken");
        TEXTURE_RENAMES.put("chorus_fruit_popped", "popped_chorus_fruit");
        TEXTURE_RENAMES.put("door_acacia", "acacia_door");
        TEXTURE_RENAMES.put("door_birch", "birch_door");
        TEXTURE_RENAMES.put("door_dark_oak", "dark_oak_door");
        ...
        TEXTURE_RENAMES.put("dye_powder_cyan", "cyan_dye");
        TEXTURE_RENAMES.put("dye_powder_gray", "gray_dye");
        TEXTURE_RENAMES.put("dye_powder_green", "cactus_green");
        TEXTURE_RENAMES.put("dye_powder_light_blue", "light_blue_dye");
        TEXTURE_RENAMES.put("dye_powder_lime", "lime_dye");
        TEXTURE_RENAMES.put("dye_powder_magenta", "magenta_dye");
        TEXTURE_RENAMES.put("dye_powder_orange", "orange_dye");
        TEXTURE_RENAMES.put("dye_powder_pink", "rose_red");
        TEXTURE_RENAMES.put("dye_powder_purple", "purple_dye");
        TEXTURE_RENAMES.put("dye_powder_red", "rose_red");
        TEXTURE_RENAMES.put("dye_powder_silver", "light_gray_dye");
        TEXTURE_RENAMES.put("dye_powder_white", "bone_meal");
        TEXTURE_RENAMES.put("dye_powder_yellow", "dandelion_yellow");
        TEXTURE_RENAMES.put("fireball", "fire_charge");
        TEXTURE_RENAMES.put("fireworks", "firework_rocket");
        TEXTURE_RENAMES.put("fireworks_charge", "firework_star");
        TEXTURE_RENAMES.put("fireworks_charge_overlay", "firework_star_overlay");
        TEXTURE_RENAMES.put("fish_clownfish_raw", "tropical_fish");
        TEXTURE_RENAMES.put("fish_cod_cooked", "cooked_cod");
        TEXTURE_RENAMES.put("fish_cod_raw", "cod");
        TEXTURE_RENAMES.put("fish_pufferfish_raw", "pufferfish");
        TEXTURE_RENAMES.put("fish_salmon_cooked", "cooked_salmon");
        TEXTURE_RENAMES.put("fish_salmon_raw", "salmon");
        TEXTURE_RENAMES.put("fishing_rod_uncast", "fishing_rod");
        TEXTURE_RENAMES.put("gold_axe", "golden_axe");
        TEXTURE_RENAMES.put("gold_boots", "golden_boots");
        TEXTURE_RENAMES.put("gold_chestplate", "golden_chestplate");
        TEXTURE_RENAMES.put("gold_helmet", "golden_helmet");
        TEXTURE_RENAMES.put("gold_hoe", "golden_hoe");
        TEXTURE_RENAMES.put("gold_horse_armor", "golden_horse_armor");
        TEXTURE_RENAMES.put("gold_leggings", "golden_leggings");
        TEXTURE_RENAMES.put("gold_pickaxe", "golden_pickaxe");
        TEXTURE_RENAMES.put("gold_shovel", "golden_shovel");
        TEXTURE_RENAMES.put("gold_sword", "golden_sword");
        TEXTURE_RENAMES.put("map_empty", "map");
        TEXTURE_RENAMES.put("map_filled", "filled_map");
        TEXTURE_RENAMES.put("map_filled_markings", "filled_map_markings");
        TEXTURE_RENAMES.put("melon", "melon_slice");
        TEXTURE_RENAMES.put("melon_speckled", "glistering_melon_slice");
        TEXTURE_RENAMES.put("minecart_chest", "chest_minecart");
        TEXTURE_RENAMES.put("minecart_command_block", "command_block_minecart");
        TEXTURE_RENAMES.put("minecart_furnace", "furnace_minecart");
        TEXTURE_RENAMES.put("minecart_hopper", "hopper_minecart");
        TEXTURE_RENAMES.put("minecart_normal", "minecart");
        TEXTURE_RENAMES.put("minecart_tnt", "tnt_minecart");
        TEXTURE_RENAMES.put("mutton_cooked", "cooked_mutton");
        TEXTURE_RENAMES.put("mutton_raw", "mutton");
        TEXTURE_RENAMES.put("netherbrick", "nether_brick");
        TEXTURE_RENAMES.put("porkchop_cooked", "cooked_porkchop");
        TEXTURE_RENAMES.put("porkchop_raw", "porkchop");
        TEXTURE_RENAMES.put("potato_baked", "baked_potato");
        TEXTURE_RENAMES.put("potato_poisonous", "poisonous_potato");
        TEXTURE_RENAMES.put("potion_bottle_drinkable", "potion");
        TEXTURE_RENAMES.put("potion_bottle_empty", "glass_bottle");
        TEXTURE_RENAMES.put("potion_bottle_lingering", "lingering_potion");
        TEXTURE_RENAMES.put("potion_bottle_splash_potion", "splash_potion");
        TEXTURE_RENAMES.put("rabbit_cooked", "cooked_rabbit");
        TEXTURE_RENAMES.put("rabbit_raw", "rabbit");
        TEXTURE_RENAMES.put("record_11", "music_disc_11");
        TEXTURE_RENAMES.put("record_13", "music_disc_13");
        TEXTURE_RENAMES.put("record_blocks", "music_disc_blocks");
        TEXTURE_RENAMES.put("record_cat", "music_disc_cat");
        TEXTURE_RENAMES.put("record_chirp", "music_disc_chirp");
        TEXTURE_RENAMES.put("record_far", "music_disc_far");
        TEXTURE_RENAMES.put("record_mall", "music_disc_mall");
        TEXTURE_RENAMES.put("record_mellohi", "music_disc_mellohi");
        TEXTURE_RENAMES.put("record_stal", "music_disc_stal");
        TEXTURE_RENAMES.put("record_strad", "music_disc_strad");
        TEXTURE_RENAMES.put("record_wait", "music_disc_wait");
        TEXTURE_RENAMES.put("record_ward", "music_disc_ward");
        TEXTURE_RENAMES.put("redstone_dust", "redstone");
        TEXTURE_RENAMES.put("seeds_melon", "melon_seeds");
        TEXTURE_RENAMES.put("seeds_pumpkin", "pumpkin_seeds");
        TEXTURE_RENAMES.put("seeds_wheat", "wheat_seeds");
        TEXTURE_RENAMES.put("slimeball", "slime_ball");
        TEXTURE_RENAMES.put("totem", "totem_of_undying");
        TEXTURE_RENAMES.put("wood_axe", "wooden_axe");
        TEXTURE_RENAMES.put("wood_hoe", "wooden_hoe");
        TEXTURE_RENAMES.put("wood_pickaxe", "wooden_pickaxe");
        TEXTURE_RENAMES.put("wood_shovel", "wooden_shovel");
