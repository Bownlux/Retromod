...
Published host jars cover Fabric and Quilt on Minecraft 1.20 through 26.3, Forge on 1.20 through 26.2, and NeoForge on 1.20.1 through 26.3. Quilt uses the shared Fabric artifact, not a separate loader artifact. Source support reaches back to 1.12.2 on Forge, 1.14.4 on Fabric, and 1.20.1 on NeoForge. GitHub releases also include an executable standalone CLI jar for offline transforms.
